                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="poppins">
                        ...
                        <div className="flex-1">
                            ...
                            <label className="input input-bordered input-info flex items-center gap-2">
                                ...
                                <input {...register("email", { required: true })} type="email" defaultValue={user.email} className="grow" placeholder="Username" />
                        ...
                        <div className="flex-1">
                            ...
                            <label className="input input-bordered input-info flex items-center gap-2">
                                ...
                                <select {...register("country", { required: true })} type="text" className="grow input-info border-0 outline-0 " placeholder="Country Name">
                        ...
                        <div className="flex gap-4 mb-3">
                            ...
                            <label className="input input-bordered input-info flex items-center gap-2">
                                ...
                                <input {...register("avg_cost", { required: true })} type="text" className="grow" placeholder="Average Cost" />
