    ...
    return (
        <div className="navbar bg-base-100 mt-6 ">
            <div className="navbar-start">
                ...
                <div tabIndex={0} role="button" className="btn pr-2 btn-ghost lg:hidden">
                ...
                <Link to={'/'} className="btn btn-ghost lg:text-3xl text-lg font-bold text-[#0c7acd] pl-0 md:pl-4 lg:pl-4 mons">
